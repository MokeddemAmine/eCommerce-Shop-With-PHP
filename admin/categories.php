    ...
    if(isset($_SESSION['useradmin'])){
        ...
        if($page == 'manage'){
            ?>
                ...
                <div class="card">
                    <div class="card-header categories-header">
                        <div class="row align-items-center">
                            <div class="col-lg-3 text-capitalize text-second-color font-weight-bold"><i class="fa-solid fa-edit"></i> <?= lang('manage categories') ?></div>
                                        ...
                                        <div class="category-content p-2 rounded mb-2">
                                            ...
                                            <div class="category-info">
                                                ...
                                                <div class="category-info text-capitalize">
                                                    <span class="btn btn-sm <?php if($cat->Visibility == 1) echo 'btn-success'; else echo 'btn-danger'; ?> text-white"><i class="fa-solid fa-eye"></i> <?= lang('visible') ?></span>
                                                    <span class="btn btn-sm <?php if($cat->Allow_Comments == 1) echo 'btn-success'; else echo 'btn-danger'; ?> text-white"><i class="fa-solid fa-comment"></i> <?= lang('comments') ?></span>
                                                    <span class="btn btn-sm <?php if($cat->Allow_Ads == 1) echo 'btn-success'; else echo 'btn-danger'; ?> text-white"><i class="fa-solid fa-tag"></i> <?= lang('ads') ?></span>
                                                </div>
                                                <?php
                                            ...
                                            <div class="category-btn">
                                                ...
                                                <a href="categories.php?do=Delete&catid=<?= $cat->CatID ?>" class="btn btn-danger btn-sm text-capitalize confirm-delete"><i class="fa-solid fa-close"></i> <?= lang('delete'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                ...
                <a href="?do=Add" class="btn bg-second-color text-main-color text-capitalize mt-3"><?= lang('add category') ?></a>
            <?php
        }elseif($page == 'Add'){
            ?>
            ...
            <form action="?do=Insert" method="POST">
                ...
                <div class="form-group row align-items-center">
                    <label for="cat-parent" class="col-2 text-capitalize font-weight-bold"><?= lang('parent') ?></label>
                    <div class="col-md-8 col-lg-6">
